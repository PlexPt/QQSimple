...
public class Common {
    ...
    public static final String KEY_MASTER_SWITCH = "mater_switch";
    ...
    public static final String KEY_ADAPTATION_VERSION = "adaptation_version";
    public static final String KEY_MARKET_COOLAPK_FEEDBACK = "market_coolapk_feedback";
