...
public class HookUtil {
    ...
    public static boolean isMoreThan755() {
        return getQQVersionName().compareTo("7.5.5") >= 0;
    }
    ...
    public static boolean isMoreThan770() {
        return getQQVersionName().compareTo("7.7.0") >= 0;
    }
